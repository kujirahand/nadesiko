 ...
 * TW_STR255 must hold less than 256 chars so length fits in first byte. *)
  TW_STR32  = array [0..34 - 1] of Char;
  TW_STR64  = array [0..66 - 1] of Char;
  TW_STR128 = array [0..130 - 1] of Char;
  TW_STR255 = array [0..256 - 1] of Char;
...
(* No DAT needed. *)
  TW_TRANSFORMSTAGE = packed record
    Decode: array [0..3 - 1] of TW_DECODEFUNCTION;
    Mix   : array [0..3 - 1, 0..3 - 1] of TW_FIX32;
  end;
...
(* TWON_ARRAY. Container for array of values (a simplified TW_ENUMERATION) *)
  TW_ARRAY = packed record
    ...
    ItemList : array [0..1 - 1] of TW_UINT8; 
...
(* TWON_ENUMERATION. Container for a collection of values. *)
  TW_ENUMERATION = packed record
    ...
    ItemList     : array[0..0] of TW_UINT8;   
                               (* Array of ItemType values starts here       *)
  end;
...
(* DAT_IMAGEINFO. Application gets detailed image info from DS with this. *)
  TW_IMAGEINFO = packed record
    ...
    BitsPerSample   : array [0..8-1] of TW_INT16;  
...
(* DAT_JPEGCOMPRESSION. Based on JPEG Draft International Std, ver 10918-1. *)
  TW_JPEGCOMPRESSION = packed record
    ...
    QuantMap         : array [0..4-1] of TW_UINT16;  (* Mapping of components to QuantTables       *)
    QuantTable       : array [0..4-1] of TW_MEMORY;  (* Quantization tables                        *)
    HuffmanMap       : array [0..4-1] of TW_UINT16;  (* Mapping of components to Huffman tables    *)
    HuffmanDC        : array [0..2-1] of TW_MEMORY;  (* DC Huffman tables                          *)
    HuffmanAC        : array [0..2-1] of TW_MEMORY;  (* AC Huffman tables                          *)
  end;
...
(* DAT_PALETTE8. Color palette when TWPT_PALETTE pixels xfer'd in mem buf. *)
  TW_PALETTE8 = packed record
    ...
    Colors      : array [0..256-1] of TW_ELEMENT8;
...
(* DAT_FILESYSTEM, information about TWAIN file system *)
  TW_FILESYSTEM = packed record
   ...
   (* DG_CONTROL / DAT_FILESYSTEM / MSG_GETINFO fields  *)
    ...
    Reserved         : array [0..512-1] of Char; (**)
 end;
 ...
 ********************************************************************)
  ...
  DSMENTRYPROC = function (pOrigin, pDest: pTW_IDENTITY;
    DG: TW_UINT32; DAT: TW_UINT16; MSG: TW_UINT16; pData: TW_MEMREF): TW_UINT16; stdcall;
