object frmMemo: TfrmMemo
  ...
  object edtMain: TEditor
    ...
    MBCSFont.Charset = DEFAULT_CHARSET
    MBCSFont.Color = clWindowText
    MBCSFont.Height = 17
    MBCSFont.Name = 'Tahoma'
    MBCSFont.Style = []
    UseMBCSFont = False
  end
